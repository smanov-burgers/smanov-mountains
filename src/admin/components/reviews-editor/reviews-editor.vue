...
export default {
    ...
    computed : {
        editorTitle: function () {
            return this.selectedReview.id < 0 ? 'Добавление Отзыва' : 'Редактирование Отзыва';
        }      
    },
    props: {
        selectedReview: {
    ...
    mounted() {
        this.renderedPhoto = this.selectedReview.photo.length>0 ? "https://webdev-api.loftschool.com/" + this.selectedReview.photo : "";
    },
    methods: {
